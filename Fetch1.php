...
return (msw << 16) | (lsw & 0xFFFF);
  ...
  return this.getTime()-(this.getTimezoneOffset()*60000); 
				...
				function validateForm()
				{
					...
					var dateformat=utcDate.getUTCFullYear()+"-"+(utcDate.getUTCMonth()+1)+"-"+utcDate.getUTCDate()+" "+utcDate.getUTCHours()+":"+utcDate.getUTCMinutes()+":"+utcDate.getUTCSeconds();
					document.getElementById("date").value = dateformat;
					var input=document.getElementById("user").value;
					document.getElementById("hash").value = md5(input);
					return true;
				}
		</script>
	</head>
